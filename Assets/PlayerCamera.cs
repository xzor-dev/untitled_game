...
public class PlayerCamera : MonoBehaviour
{
	...
	void LateUpdate ()
	{
		...
		// If mouse left click buttons is down, let the mouse govern camera position
		if (GUIUtility.hotControl == 0) {
            ...
            // If mouse right click buttons is down, let the mouse govern camera position
            ...
            else if (Input.GetAxis("Vertical") != 0 || Input.GetAxis("Horizontal") != 0)
			{
				...
				xDeg = Mathf.LerpAngle (currentRotationAngle, targetRotationAngle, rotationDampening * Time.deltaTime * 4);
			}
		}
